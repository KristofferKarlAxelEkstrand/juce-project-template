...
| RealtimeSanitizer          | `./scripts/run-with-sanitizer.sh rtsan` | Real-time violations            | 19+ required  |

**Note**: RealtimeSanitizer (rtsan) requires Clang 19 or later. The dev container provides Clang 20.
